<?php
/**
 * @package     Icigon\Laravel\Utils\Bus\Repository
 * @author      singkek
 ...
 * @updated     2020-02-07
 **/
namespace Icigon\Laravel\Utils\Bus;

use Icigon\Laravel\Utils\Library\Redis;
...
trait Repository
{
    ...
    {
        $connection = $connection == 'default' ? Env::get('DB_CONNECTION') : $connection;
     ...
     * @return bool
     */
    public function mysql_force_group_by()
    {
